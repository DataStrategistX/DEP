This project of data science is about creating a real estate Predicting House Prices model. We'll start by developing a model using scikit-learn and linear regression,
